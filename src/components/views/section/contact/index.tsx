  ...
  return (
    <section id="contact" className="py-20 min-h-screen flex flex-col justify-center bg-gray-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header */}
        <div className="max-w-2xl mx-auto text-center mb-8 sm:mb-12 lg:mb-16">
        ...
        <div className="max-w-4xl lg:max-w-6xl mx-auto">
          <div className="bg-gray-900/70 backdrop-blur-lg border border-gray-800 rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden shadow-lg sm:shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
              {/* Contact Info Sidebar */}
              <div className="bg-gradient-to-b from-gray-900 to-gray-800 p-4 sm:p-6 lg:p-8 flex flex-col lg:col-span-1">
                <div>
                  ...
                  <div className="space-y-4 sm:space-y-5 lg:space-y-6">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className='min-w-0 flex-1'>
                        ...
                        <a href="mailto:stevenjonathanalfredo785@gmail.com" className="text-xs sm:text-sm text-gray-400 hover:text-purple-400 transition-colors inline-block mt-1 break-all">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className='min-w-0 flex-1'>
                        <h4 className="text-sm sm:text-base font-semibold text-white">Location</h4>
                        <p className="text-xs sm:text-sm text-gray-400 mt-1">Semarang, Indonesia</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 lg:mt-12">
                  <h4 className="text-white text-sm sm:text-base font-semibold mb-3 sm:mb-4 relative">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {/* GitHub */}
                    <a href="https://github.com/StevenJ0" className="bg-gray-800 hover:bg-gray-700 text-white p-2 rounded-lg transition-all hover:-translate-y-0.5 hover:shadow-md">
                    ...
                    {/* LinkedIn */}
                    <a href="www.linkedin.com/in/steven-sihombing" className="bg-gray-800 hover:bg-gray-700 text-white p-2 rounded-lg transition-all hover:-translate-y-0.5 hover:shadow-md">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Instagram */}
                    <a href="https://www.instagram.com/steven_shmbng/" className="bg-gray-800 hover:bg-gray-700 text-white p-2 rounded-lg transition-all hover:-translate-y-0.5 hover:shadow-md">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Form Section */}
              <div className="p-4 sm:p-6 lg:p-8 lg:col-span-2">
                <h3 className="text-2xl font-bold text-white mb-8 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={4}
                        className={`w-full bg-gray-800/70 border ${errors.message ? 'border-red-500/70' : 'border-gray-700 hover:border-gray-600'} rounded-lg pl-10 pr-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all`}
                  ...
                  <button
                    ...
                    className={`w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-4 rounded-lg font-medium flex items-center justify-center gap-2 hover:shadow-lg transition-all text-sm sm:text-base ${isSubmitting ? 'opacity-80 cursor-not-allowed' : 'hover:-translate-y-0.5 hover:shadow-blue-500/30'}`}
                  >
                    {isSubmitting ? (
                      <>
