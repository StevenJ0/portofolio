const en = {
  ...
  about: {
    ...
    bio2: "Currently, I am a second-year Computer Science student at Diponegoro University, keenly interested in technology, particularly in Software Engineering and Data Science.",
    ...
    items: [
      {
        ...
        description: "Covered corporate activities, wrote and edited news for communication channels, collaborated across divisions.",
        current: false,
      },
      {
        year: "2025",
        ...
        period: "June – August 2025",
        description: "Provided tech support to end-users, troubleshot hardware/software issues, maintained IT infrastructure.",
        current: false,
      },
      {
        year: "2025",
        ...
        company: "BoxSL",
        period: "April 2025",
        description: "Developed and managed e-commerce features for an engagement products web platform using Next.js.",
        current: false,
      },
      {
        year: "2025",
        ...
        description: "Managed and developed the website for Diponegoro Chemistry Fair using Next.js and Supabase.",
        current: false,
      },
      {
        year: "2024",
        ...
        description: "Collaborated on social initiatives, led flagship events, and ensured smooth program execution.",
        current: false,
      },
      {
        year: "2023",
        ...
        period: "2023 – Present",
        description: "Studying Informatics with a focus on software engineering and data science.",
        current: true,
      },
    ],
  },
