const id = {
  ...
  hero: {
    ...
    bio: "Membangun sistem backend yang skalabel dan aplikasi cerdas. Spesialisasi dalam clean architecture, sistem terdistribusi, dan solusi berbasis AI.",
    contactMe: "Hubungi Saya",
    viewResume: "Lihat Resume",
    scrollDown: "Gulir ke bawah",
    badgeYears: "2+",
    badgeYearsLabel: "Tahun Pengalaman",
    badgeProjects: "7+",
  ...
  about: {
    ...
    titleHighlight: "Saya",
    heading: "Siapa Saya?",
    bio1: "Saya Steven Jonathan Sihombing, seorang Software Engineer dengan fokus kuat pada pengembangan backend. Saya mengkhususkan diri dalam merancang RESTful API yang skalabel, pola clean architecture, dan membangun sistem yang andal untuk aplikasi dunia nyata.",
    bio2: "Saya adalah mahasiswa Informatika tahun akhir di Universitas Diponegoro, sangat bersemangat di bidang Rekayasa Perangkat Lunak dan saat ini sedang memperluas keahlian ke AI Engineering — mengeksplorasi bagaimana machine learning dan sistem cerdas dapat diintegrasikan ke dalam aplikasi production-grade.",
    bio3: "Berpengalaman memimpin proyek teknis secara end-to-end, mulai dari desain arsitektur hingga deployment. Saya berkembang dalam lingkungan kolaboratif dan berkomitmen menulis kode yang bersih dan mudah dipelihara untuk memecahkan masalah yang bermakna.",
